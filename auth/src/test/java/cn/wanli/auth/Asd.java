...
import cn.wanli.auth.domain.Cc;
...
public class Asd {
    ...
    @Test
    public void asd() {
        String sds = "[{\"total\":0,\"name\":\"百万人员布控\"},{\"total\":0,\"name\":\"布控测试\"}]";
        List<JSONObject> collect = JSON.parseArray(sds, JSONObject.class)
                .stream()
                .sorted((i, j) -> j.getLong("total").compareTo(i.getLong("total")))
    ...
    @Test
    public void ddsad() throws JsonProcessingException {
        JSONObject obj = new JSONObject();
        obj.put("feature", "");
        obj.put("feature", Bytes.asList(Base64.getDecoder().decode(obj.getString("feature"))));

        Cc cc = obj.toJavaObject(Cc.class);
//        cc.setAa(Bytes.asList(cc.getFeature()));
        System.out.println(JSON.toJSONString(cc));

        ObjectMapper om = new ObjectMapper();
        Cc c2 = om.readValue(om.writeValueAsString(obj), Cc.class);
