...
public class RedisTokenStore implements TokenStore {
    ...
    private static final String AUTH = "auth:auth:";
    ...
    private static final String CLIENT_ID_TO_ACCESS = "auth:client_id_to_access:";
    ...
    private RedisTokenStoreSerializationStrategy serializationStrategy = new TokenStoreSerializationStrategy();
